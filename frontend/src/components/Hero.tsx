  ...
  return (
    <section className="container flex flex-col items-center justify-center space-y-6 py-12 md:py-16 mt-2">
      ...
      <div className="text-center space-y-2">
        <h1 className="text-2xl font-bold leading-tight tracking-tighter md:text-4xl lg:text-5xl lg:leading-[1.1] max-w-4xl mx-auto text-center flex flex-wrap items-center justify-center gap-x-3 gap-y-2">
          Your Ollama Server is Now a{" "}
          <span className="bg-gradient-to-r from-blue-600 to-orange-500 bg-clip-text text-transparent whitespace-nowrap">
            Public AI Playground
          </span>
        </h1>
        
        <div className="max-w-2xl mx-auto text-sm text-muted-foreground md:text-base mt-4 space-y-1">
